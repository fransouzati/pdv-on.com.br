...
class ProdutoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $produtos = $em->getRepository('AppBundle:Produto')->findAll();
    ...
    {
        $produto = new Produto();
        $form = $this->createForm('AppBundle\Form\ProdutoType', $produto);
    ...
    {
        $deleteForm = $this->createDeleteForm($produto);
        $editForm = $this->createForm('AppBundle\Form\ProdutoType', $produto);
